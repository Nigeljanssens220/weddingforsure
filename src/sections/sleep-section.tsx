            ...
            <DialogTrigger>
              <Card className="relative w-screen max-w-sm rounded-md md:max-w-2xl lg:max-w-3xl">
                <Image
                  ...
                  className="left-0 top-0 max-h-[170px] rounded-md object-cover grayscale md:max-h-[305px] lg:max-h-[350px]"
                />
                <div className="absolute bottom-0 left-0 w-full rounded-md bg-black  bg-opacity-10 px-4 py-2 text-start backdrop-blur-sm md:py-4">
