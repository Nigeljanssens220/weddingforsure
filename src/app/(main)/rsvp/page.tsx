...
const RSVP = () => {
  return (
    <div className="flex min-h-dvh w-full flex-col items-center px-8 selection:bg-black selection:text-[#C78686] md:mt-32">
      <div className="grid gap-4 md:grid-cols-2">
        <div className="flex flex-col items-center gap-4 pt-10 text-center md:items-start md:pt-36 md:text-start">
