      ...
      <Dialog>
        ...
        <DialogContent className="h-fit w-screen max-w-sm overflow-hidden rounded-md p-0 md:max-w-2xl lg:max-w-3xl">
          ...
          <div className="mt-6 flex flex-col gap-4 pb-6 md:mt-10">
            ...
            <Typography as="p">
              Het hotel waar wij de nacht doorbrengen! Kom de volgende dag gezellig met ons nagenieten bij het ontbijt.
              We kunnen een groepsreservering maken met 5% korting. Dus laat in de RSVP weten of je hier wilt
              overnachten!
            </Typography>
          </div>
        </DialogContent>
      ...
      <Dialog>
        ...
        <DialogContent className="h-fit w-screen max-w-sm overflow-hidden rounded-md p-0 md:max-w-2xl lg:max-w-3xl ">
          ...
          <div className="mt-6 flex flex-col gap-4 pb-6 md:mt-10">
            ...
            <Typography as="p">
              Een hotel met een eigen bos en gratis parkeergelegenheid. Helaas is het voor ons niet mogelijk om hier een
              groepsreservering te maken!
            </Typography>
          </div>
        </DialogContent>
      </Dialog>
