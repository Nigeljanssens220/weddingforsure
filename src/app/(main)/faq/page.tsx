      ...
      <div className="mx-auto grid max-w-screen-2xl gap-8 px-8 md:grid-cols-2 md:px-0">
        ...
        <article className="space-y-8">
          ...
          <div className="space-y-1">
            ...
            <Typography as="p">
              Helaas hebben wij besloten om de bruiloft kindvrij te houden. Wij hopen dat jullie begrip hebben voor deze
          ...
          <div className="space-y-1">
            ...
            <Typography as="p">
              Wat ons betreft maakt dit het feestje compleet. Wij zullen zelf in een pak en trouwjurk trouwen, maar wij
              vinden het ook leuk als jullie je mooiste jurk of pak aantrekken.
              <br />
              <br />
              Het thema van het feest is <span className="italic">whimsical summer pastels</span> en wij zouden het heel
              erg waarderen als jullie je kleding hierop aanpassen. Daarnaast is het allerbelangrijkste natuurlijk dat
              je je goed voelt in wat je aanhebt en dat je er stralend uitziet!
              <br />
              <br />
      ...
      <div className="mx-auto grid max-w-screen-2xl gap-8 px-8 md:grid-cols-2 md:px-0">
        ...
        <article className="space-y-8">
          <div className="space-y-1">
            ...
            <Typography as="p">
              De RSVP helpt ons enorm om een overzicht te krijgen van onze gasten en diens wensen tijdens de bruiloft en
          ...
          <div className="space-y-1">
            ...
            <Typography as="p">
              Het is niet nodig om nog te reageren op de uitnodiging. Je kunt de RSVP online invullen, dan weten wij dat
              je erbij kunt zijn!
            </Typography>
          </div>
          <div className="space-y-1">
            ...
            <Typography as="p">
              Omdat wij de hoeveelheid gasten en eventuele dieetwensen moeten doorgaven aan de trouwlocatie, hebben wij
      ...
      <div className="mx-auto grid max-w-screen-2xl gap-8 px-8 md:grid-cols-2 md:px-0">
        ...
        <article className="space-y-8">
          <div className="space-y-1">
            ...
            <Typography as="p">
              De bruiloft zal plaatsvinden in hartje zomer en we hopen dan ook dat de ceremonie buiten in de tuin van de
              locatie voldaan kan worden. De overige delen van de bruiloft zullen binnen plaatsvinden. Het is en blijft
          ...
          <div className="space-y-1">
            ...
            <Typography as="p">
              Wij hebben vooraf geen kamers gereserveerd voor de gasten, maar er zijn een aantal hotels in de buurt van
              de trouwlocatie. Wij raden aan om een hotel te boeken in Driebergen-Rijsenburg, Zeist of Utrecht.
              <br />
              <br />
              Tip: in de RSVP is er een optie om aan te geven of je geïnteresseerd bent in een hotelovernachting. Als er
      ...
      <div className="mx-auto grid max-w-screen-2xl gap-8 px-8 md:grid-cols-2 md:px-0">
        ...
        <article className="space-y-8">
          ...
          <div className="space-y-1">
            ...
            <Typography as="p">
              Wij willen jullie vragen om eventuele dieetwensen zo snel mogelijk aan te geven in de RSVP. Wij zullen ons
      ...
      <div className="mx-auto grid max-w-screen-2xl gap-8 px-8 md:grid-cols-2 md:px-0">
        ...
        <article className="space-y-8">
          <div className="space-y-1">
            ...
            <Typography as="p">
              Wij vragen uiteraard niet om cadeaus, jullie aanwezigheid is al een cadeau op zich! Zo lekker cheesy zijn
              wij wel. Mochten jullie echt iets willen geven:
              <br />
              <br />
